...
// as part of Lab 11, modify this program to use UART0 instead of UART1 //====> Already Done??
...
// as part of Lab 11 implement this function
	...
	do
	{	
		while((UART0_FR_R&0x0020) != 0);  // wait if the buffer is full
		//data = buffer[i];
...
// as part of Lab 11 implement this function
  ...
  while(n);// repeat until n==0
	...
	{
		String[0] = 0+0x30;String[2] = 0+0x30;String[3] = 0+0x30;String[4] = 0+0x30;
		...
		if(cnt == 1)
		{
			String[4] = buffer[cnt-1]+0x30;
		}
		if(cnt == 2)
		{
			String[4] = buffer[cnt-2]+0x30;
			String[3] = buffer[cnt-1]+0x30;
		}
		if(cnt == 3)
		{
			String[4] = buffer[cnt-3]+0x30;
			String[3] = buffer[cnt-2]+0x30;
			String[2] = buffer[cnt-1]+0x30;
		}
		if(cnt == 4)
		{
			String[4] = buffer[cnt-4]+0x30;
			String[3] = buffer[cnt-3]+0x30;
			String[2] = buffer[cnt-2]+0x30;
			String[0] = buffer[cnt-1]+0x30;
		}
